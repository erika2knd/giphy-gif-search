...
class GifDetailsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final title = gif.title.trim().isEmpty ? 'Untitled GIF' : gif.title.trim();
    final usernameRaw = gif.username.trim();
    final username = usernameRaw.isEmpty ? 'Unknown author' : '@$usernameRaw';

    final imageUrl = gif.originalUrl.isNotEmpty
        ? gif.originalUrl
        : gif.previewUrl;
